...
function HiddenJs(props) {
  ...
  return (0, import_jsx_runtime48.jsx)(React43.Fragment, {
    children
  });
}
...
var MobileStepper = React56.forwardRef(function MobileStepper2(inProps, ref) {
  ...
  return (0, import_jsx_runtime62.jsxs)(MobileStepperRoot, _extends({
    ...
    children: [backButton, variant === "text" && (0, import_jsx_runtime62.jsxs)(React56.Fragment, {
      ...
      children: [...new Array(steps)].map((_, index) => (0, import_jsx_runtime63.jsx)(MobileStepperDot, {
...
var PaginationItemPage = styled_default(ButtonBase_default, {
  ...
  [`&.${paginationItemClasses_default.selected}`]: _extends({}, ownerState.color !== "standard" && {
    ...
    border: `1px solid ${theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / 0.5)` : (0, import_colorManipulator7.alpha)(theme.palette[ownerState.color].main, 0.5)}`,
    backgroundColor: theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / ${theme.vars.palette.action.activatedOpacity})` : (0, import_colorManipulator7.alpha)(theme.palette[ownerState.color].main, theme.palette.action.activatedOpacity),
    "&:hover": {
      backgroundColor: theme.vars ? `rgba(${theme.vars.palette[ownerState.color].mainChannel} / calc(${theme.vars.palette.action.activatedOpacity} + ${theme.vars.palette.action.focusOpacity}))` : (0, import_colorManipulator7.alpha)(theme.palette[ownerState.color].main, theme.palette.action.activatedOpacity + theme.palette.action.focusOpacity),
      // Reset on touch devices, it doesn't add specificity
      "@media (hover: none)": {
        backgroundColor: "transparent"
      }
...
var _excluded53 = ["actions", "children", "className", "defaultValue", "name", "onChange", "value"];
...
var SpeedDialActionFab = styled_default(Fab_default, {
  ...
  backgroundColor: (theme.vars || theme).palette.background.paper,
  "&:hover": {
    backgroundColor: theme.vars ? theme.vars.palette.SpeedDialAction.fabHoverBg : (0, import_colorManipulator11.emphasize)(theme.palette.background.paper, 0.15)
  },
  transition: `${theme.transitions.create("transform", {
...
var SwipeableDrawer = React97.forwardRef(function SwipeableDrawer2(inProps, ref) {
  ...
  const {
    ...
    variant = "temporary"
    // Mobile first.
  } = props, ModalPropsProp = _objectWithoutPropertiesLoose(props.ModalProps, _excluded71), other = _objectWithoutPropertiesLoose(props, _excluded216);
...
var Tab = React99.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime114.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime114.jsxs)(React99.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime114.jsxs)(React99.Fragment, {
      children: [label, icon]
    }), indicator]
  }));
});
...
var TableContainer = React102.forwardRef(function TableContainer2(inProps, ref) {
  ...
  return (0, import_jsx_runtime117.jsx)(TableContainerRoot, _extends({
    ref,
    as: component,
    className: clsx_default(classes.root, className),
    ownerState
...
var TableFooter = React103.forwardRef(function TableFooter2(inProps, ref) {
  ...
  return (0, import_jsx_runtime118.jsx)(Tablelvl2Context_default.Provider, {
    value: tablelvl22,
    children: (0, import_jsx_runtime118.jsx)(TableFooterRoot, _extends({
      as: component,
      className: clsx_default(classes.root, className),
      ref,
...
var TableHead = React104.forwardRef(function TableHead2(inProps, ref) {
  ...
  return (0, import_jsx_runtime119.jsx)(Tablelvl2Context_default.Provider, {
    value: tablelvl23,
    children: (0, import_jsx_runtime119.jsx)(TableHeadRoot, _extends({
      as: component,
      className: clsx_default(classes.root, className),
      ref,
...
var TableRow = React105.forwardRef(function TableRow2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTableRow"
  });
  ...
  const tablelvl24 = React105.useContext(Tablelvl2Context_default);
  const ownerState = _extends({}, props, {
    component,
    hover,
    selected,
  ...
  return (0, import_jsx_runtime120.jsx)(TableRowRoot, _extends({
    as: component,
    ref,
    className: clsx_default(classes.root, className),
...
var TableSortLabel = React107.forwardRef(function TableSortLabel2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTableSortLabel"
  });
  ...
  return (0, import_jsx_runtime123.jsxs)(TableSortLabelRoot, _extends({
    className: clsx_default(classes.root, className),
    component: "span",
    disableRipple: true,
    ownerState,
...
function ScrollbarSize(props) {
  ...
  const scrollbarHeight = React108.useRef();
  ...
  return (0, import_jsx_runtime124.jsx)("div", _extends({
    style: styles3,
    ref: nodeRef
  }, other));
}
...
var TabScrollButton = React109.forwardRef(function TabScrollButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime125.jsx)(TabScrollButtonRoot, _extends({
    component: "div",
    className: clsx_default(classes.root, className),
    ref,
    role: null,
    ...
    children: direction === "left" ? (0, import_jsx_runtime125.jsx)(StartButtonIcon, _extends({}, startButtonIconProps)) : (0, import_jsx_runtime125.jsx)(EndButtonIcon, _extends({}, endButtonIconProps))
  }));
});
...
var Tabs = React110.forwardRef(function Tabs2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTabs"
  });
  ...
  const [indicatorStyle, setIndicatorStyle] = React110.useState(defaultIndicatorStyle);
  const [displayStartScroll, setDisplayStartScroll] = React110.useState(false);
  const [displayEndScroll, setDisplayEndScroll] = React110.useState(false);
  const [updateScrollObserver, setUpdateScrollObserver] = React110.useState(false);
  const [scrollerStyle, setScrollerStyle] = React110.useState({
    overflow: "hidden",
    scrollbarWidth: 0
  });
  const valueToIndex = /* @__PURE__ */ new Map();
  const tabsRef = React110.useRef(null);
  const tabListRef = React110.useRef(null);
  const getTabsMeta = () => {
  ...
  const handleScrollbarSizeChange = React110.useCallback((scrollbarWidth) => {
    setScrollerStyle({
      overflow: null,
      scrollbarWidth
    });
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollbarSizeListener = scrollable ? (0, import_jsx_runtime126.jsx)(TabsScrollbarSize, {
      onChange: handleScrollbarSizeChange,
      className: clsx_default(classes.scrollableX, classes.hideScrollbar)
    }) : null;
    const scrollButtonsActive = displayStartScroll || displayEndScroll;
    const showScrollButtons = scrollable && (scrollButtons === "auto" && scrollButtonsActive || scrollButtons === true);
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime126.jsx)(ScrollButtonComponent, _extends({
      slots: {
    ...
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime126.jsx)(ScrollButtonComponent, _extends({
      slots: {
  ...
  React110.useImperativeHandle(action, () => ({
    updateIndicator: updateIndicatorState,
    updateScrollButtons: updateScrollButtonState
  }), [updateIndicatorState, updateScrollButtonState]);
  const indicator = (0, import_jsx_runtime126.jsx)(TabsIndicator, _extends({}, TabIndicatorProps, {
  ...
  const children = React110.Children.map(childrenProp, (child) => {
    ...
    childIndex += 1;
    return React110.cloneElement(child, _extends({
  ...
  return (0, import_jsx_runtime127.jsxs)(TabsRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    as: component
  }, other, {
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime127.jsxs)(TabsScroller, {
      ...
      ref: tabsRef,
      children: [(0, import_jsx_runtime126.jsx)(FlexContainer, {
        "aria-label": ariaLabel,
        "aria-labelledby": ariaLabelledBy,
...
var ToggleButtonGroupContext = React111.createContext({});
if (true) {
...
var ToggleButtonGroupButtonContext = React112.createContext(void 0);
if (true) {
...
var ToggleButton = React113.forwardRef(function ToggleButton2(inProps, ref) {
  const _React$useContext = React113.useContext(ToggleButtonGroupContext_default), {
    value: contextValue
  } = _React$useContext, contextProps = _objectWithoutPropertiesLoose(_React$useContext, _excluded84);
  const toggleButtonGroupButtonContextPositionClassName = React113.useContext(ToggleButtonGroupButtonContext_default);
  ...
  return (0, import_jsx_runtime128.jsx)(ToggleButtonRoot, _extends({
...
var ToggleButtonGroup = React114.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  ...
  const handleChange = React114.useCallback((event, buttonValue) => {
    if (!onChange) {
      return;
    }
  ...
  const handleExclusiveChange = React114.useCallback((event, buttonValue) => {
    if (!onChange) {
      return;
    }
    onChange(event, value === buttonValue ? null : buttonValue);
  }, [onChange, value]);
  const context = React114.useMemo(() => ({
    className: classes.grouped,
  ...
  return (0, import_jsx_runtime129.jsx)(ToggleButtonGroupRoot, _extends({
    role: "group",
    className: clsx_default(classes.root, className),
    ref,
    ownerState
  }, other, {
    children: (0, import_jsx_runtime129.jsx)(ToggleButtonGroupContext_default.Provider, {
      value: context,
      children: validChildren.map((child, index) => {
        if (true) {
        ...
        return (0, import_jsx_runtime129.jsx)(ToggleButtonGroupButtonContext_default.Provider, {
          value: getButtonPositionClassName(index),
          children: child
        }, index);
      })
